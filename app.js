...
const courseData = {
    ...
    ch4: [
        { id: "4-1", title: "모션그래픽 템플릿(.mogrt) 사용법", duration: "5분", desc: "그래픽 템플릿 패널 열기, 타이틀 템플릿 드래그 적용, 텍스트·색상 커스터마이징", caption: "템플릿 디자인을 다운받고, 수정은 내 맘대로", resource: "내장 템플릿", image: "mogrt_usage_concept.png" },
