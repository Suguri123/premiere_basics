...
const courseData = {
    ...
    ch4: [
        ...
        { id: "4-4", title: "생성형 확장으로 짧은 클립 늘리기", duration: "5분", desc: "도구메뉴에서 생성형 확장 도구 선택 → 타임라인에서 영상클립의 끝을 드래그 → AI가 비디오 2초, 오디오는 10초, 비디오+오디오는 2초까지 연장본 생성", caption: "부족한 1~2초는 AI에게", resource: "" },
