...
const courseData = {
    ...
    ch4: [
        ...
        { id: "4-7", title: "숏폼 시퀀스 설정과 기획", duration: "5분", desc: "1080×1920(9:16) 시퀀스 생성, 숏폼 3초 훅의 중요성, 15~30초 구성안 짜기", caption: "첫 3초에 결과물부터 보여주기", resource: "기획 템플릿" },
        { id: "4-8", title: "숏폼 편집 — 컷·자막·음악 몰아치기", duration: "6분", desc: "빠른 컷 편집 리듬, AI 자동 자막을 숏폼 스타일(큰 글씨·중앙 하단)로 변환, 비트에 컷 맞추기", caption: "숏폼 자막은 크게, 짧게, 중앙에", resource: "완성 프로젝트 D" },
        { id: "4-9", title: "숏폼 내보내기와 업로드 규격", duration: "4분", desc: "내보내기 설정(H.264, 유튜브 1080p Full HD 프리셋), 쇼츠/릴스 규격·용량, 업로드 시 제목·해시태그 요령", caption: "쇼츠는 60초 이내, #shorts", resource: "규격 비교표" },
        { id: "4-10", title: "결과물 셀프 점검과 다음 단계", duration: "5분", desc: "자주 하는 실수 체크리스트(자막 가독성·오디오 밸런스·과한 전환) 셀프 점검, 수강생 결과물 피드백 예시, 심화 학습 로드맵(색보정·합성) 안내", caption: "업로드 전 10초 체크리스트", resource: "셀프 점검표" }
    ]
};
